...
default['selenium']['url'] = 'http://selenium-release.storage.googleapis.com/2.45'
default['selenium']['jar'] =  'selenium-server-standalone-2.45.0.jar'
default['selenium']['config'] = 'config'

default['chromedriver']['url'] = 'http://chromedriver.storage.googleapis.com'
default['chromedriver']['version'] = '2.15'
